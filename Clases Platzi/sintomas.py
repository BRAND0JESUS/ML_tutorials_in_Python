...
if __name__ == '__main__':      # Punto de entrada del programa ejecutado desde consola
    prob_cancer = 1/100000
    prob_sintoma_dado_cancer = 1
    prob_sintoma_dado_no_cancer = 10/99999
    prob_no_cancer = 1 - prob_cancer

    prob_sintoma = (prob_cancer * prob_sintoma_dado_cancer) \
        + (prob_no_cancer * prob_sintoma_dado_no_cancer)
