#Como se sabe los lanzamientos de datos tienen una distribución uniforme, 
#debido a que cada número tiene las mismas posibilidades que salir que los otros 5 => (1/6). 
# Entonces lo que hice fue crear un script donde se realiza una cantidad de lanzamientos de dados 
# y se obtenga la cantidad de veces que salio cada número, luego seleccionar muestras de 10 lanzamientos 
# y hallar su media. Con 1000 lanzamientos:"
